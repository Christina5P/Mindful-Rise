...
from .views import PostDetailView, PostList, blog_index, category_search, blog_category, like_post, courses_index, PostEditView, PostDeleteView
...
urlpatterns = [
    ...
    path('post/edit/<int:pk>/', PostEditView.as_view(), name='post-edit'),  #edit comments
    path('post/delete/<int:pk>/', PostDeleteView.as_view(), name='post-delete'),  # delete comments
